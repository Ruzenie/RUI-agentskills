...
def build_entry_text(template_text: str, platform: str, locale: str) -> str:
    ...
    title = "exportenenen" if is_cn else "Bundle Entry"
    lines = []
    ...
    if is_cn:
        lines.append(f"- enenenen: `{index_path}`")
        lines.append("- structurevalidate: `python3 skills/skill-structure-governor/scripts/validate_structure.py`")
    else:
...
def main() -> int:
    ...
    bundles = [
        {"name": "codex-cn", "platform": "codex", "locale": "CN", "entry": "AGENTS.md", "template": codex_template_cn},
        {"name": "codex-en", "platform": "codex", "locale": "EN", "entry": "AGENTS.md", "template": codex_template_en},
        {"name": "claude-cn", "platform": "claude", "locale": "CN", "entry": "CLAUDE.md", "template": claude_template_cn},
        {"name": "claude-en", "platform": "claude", "locale": "EN", "entry": "CLAUDE.md", "template": claude_template_en},
    ]
